...
import type { AudioFile as _AudioFile, ExternalBlob as _ExternalBlob, PlanType as _PlanType, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addAudioFile(arg0: string, arg1: string, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAudioFile(arg0, arg1, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addUserProfile(arg0: Principal, arg1: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addUserProfile(arg0, to_candid_UserProfile_n9(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteAudioFile(arg0: AudioFile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteAudioFile(await to_candid_AudioFile_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserAudioFiles(arg0: Principal): Promise<Array<AudioFile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAudioFiles(arg0);
                return from_candid_vec_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserCountByPlan(arg0: PlanType): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCountByPlan(to_candid_PlanType_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetMonthlyExports(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetMonthlyExports();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserPlan(arg0: Principal, arg1: PlanType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserPlan(arg0, to_candid_PlanType_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async useExport(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.useExport();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AudioFile_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AudioFile): Promise<AudioFile> {
...
function from_candid_PlanType_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PlanType): PlanType {
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        exportsRemaining: value.exportsRemaining,
        name: value.name,
        plan: from_candid_PlanType_n20(_uploadFile, _downloadFile, value.plan)
    };
}
...
function from_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "creator" in value ? PlanType.creator : "studio" in value ? PlanType.studio : "free" in value ? PlanType.free : "full" in value ? PlanType.full : value;
}
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AudioFile>): Promise<Array<AudioFile>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AudioFile_n23(_uploadFile, _downloadFile, x)));
}
async function to_candid_AudioFile_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AudioFile): Promise<_AudioFile> {
...
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PlanType): {
    ...
    return value == PlanType.creator ? {
        creator: null
    } : value == PlanType.studio ? {
        studio: null
    } : value == PlanType.free ? {
        free: null
    } : value == PlanType.full ? {
